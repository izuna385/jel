    ...
    if not os.path.exists(cache_path):
        ...
        with tempfile.NamedTemporaryFile() as temp_file:  # type: IO
            ...
            if 'https://drive.google.com/file/d/' in url:
                id = url.replace('https://drive.google.com/file/d/', '').split('/')[0]
                download_file_from_google_drive(id, temp_file)
            else:
...
if __name__ == '__main__':
    url = 'https://drive.google.com/drive/folders/1fOKw46uljEDJi3ezfDHQ9JBg5PoWLifo'
    cached_path(url)